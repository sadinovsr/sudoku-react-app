...
describe('gridCreator()', () => {
  it('should create grid object from string', () => {
    const string = '001000000200100800034000000010070000400000000000000980100000000000010008002000000';
    const output = {
    ...
    expect(gridCreator(string)).toEqual(output);
  })
})